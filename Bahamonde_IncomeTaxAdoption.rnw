...
It is important to emphasize that we refer to taxation and bureaucratization processes \emph{after} the independence. A simple association between bureaucratic and democratic developments would be incorrect. As \citet[p. 26]{Mahoney:2010aa} suggests, there is a negative association between ``mercantilist institutions'' (which required a very complex bureaucratic network) and political development. For example, Per\'u had very strong ``mercantilist institutions'', and hence it shows lower levels of political development. Similarly, \citet{Acemoglu:2002uh} explain how colonial mercantilist countries show little economic growth\footnote{\citet[p. 43]{Rota2011a} explains that ``[t]he modernization of bureaucracy preceded the process of democratization''.}. Bureaucratization \emph{per se} does not cause state capacities either. \citet[]{Soifer} explains that ``local'' bureaucrats (as opposed to central/state bureaucrats) carry their own agendas, undermining the state consolidation at the local level. 



“argues that institutions of local rule played a primary role in determining the outcomes of the efforts of state leaders to develop the power of their states [...] when state leaders delegated local [...] administration to local elites, their efforts to increase state power foundered [but when] they deployed bureaucrats to the provinces, their efforts were more successful. Historical evidence from Peru and Chile about the development of military capacity [i.e., military conscription] and public primary education5 supports the power of the institutional explanation against alternatives such as war and ethnic diversity”. Specifically, “[u]nder deployed rule, state agents owe their job, and therefore their principal source of income, to the government [...] On the other hand, local elites serving as agents in the state bureaucracy generate most of their income from [...] other aspects of their status in the local community and not their state salaries6, making them less responsive to central state pressures”. More importantly, “Local elites [...] under delegated rule [...] rely mainly on traditional authority and private power to pursue their goals. Thus they have a much weaker interest in the expanded reach of the state”. Also, in Chile, “[s]ince soldiers were selected for service by local authorities and not recruited directly by military units, units mixed soldiers from across the country. This helped to create a unified and national army”.
