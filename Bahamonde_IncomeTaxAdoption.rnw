...
\paragraph{Weak States: A story of uncontested economic elites and political monopoly} When industrial output was not large-enough to compensate for long-term losses associated to future taxation of little revenues, incumbents engaged in predatory strategies. Contrary to \citet[p. 127]{Acemoglu2000a}, industrial development is not blocked by agricultural elites ``because there is no credible commitment to compensate them once economic changes have been implemented'', but because the \emph{political} threat of being displaced by a weak economic sector was too small. However the blocking/expropriation acts as a way to provide to the rulers instantaneous liquidity in the short-term. 

% HERE include more on developmentalist states and expropriatory states

\citet[p. 4]{Robinson1999}: ``the \emph{more encompassing an elite} and  the \emph{longer its time horizon}, the \emph{more likely} it is to be predatory''
