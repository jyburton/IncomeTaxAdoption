...
The literature on state\footnote{Following \citet[p. 6]{Rueschemeyer:1992}, we define ``state'' as ``the set of organizations involved in making and implementing binding collective decisions, if necessary by force''.} formation situates taxation as one of the two main state capacities\footnote{
...
Sectoral outputs measure the levels of inter-elite conflict. The degree in which industrial output catches up with agricultural output represents the degree in which the industrial sector \emph{challenges} the agricultural sector. In other words, we are interested in measuring different levels of inter-sectoral inequality. As we explain below, political monopolies were terminated when the levels of inter-sectoral equality were high. However, when inter-sectoral equality was low, political resources were oriented to perpetuate the legacies of the colonial period, prioritizing policy goods for the agricultural sector. 

%  political competition and state capacities
The association between (the lack of) economic and political competition and (the lack of) state capacities is not new. \citet[p. 481]{Kurtz2009} argues that where ``no faction can easily become permanently dominant'', state capacities should be higher. \citet[p. 40]{Cardenas2010} in his formal and empirical models finds that ``concentration of political and economic power reduces the incentives to invest in state capacity''. However, he models inequality between \emph{elites} and \emph{citizens}. We expand on this idea by modeling the period \emph{before} full democratization existed and also by modeling the interest of two types of elites. The sectoral origins of income taxation has been approached before too. From a development perspective in Central America,  \citet[p. 55]{Best1976}, argues that ``the sectoral origin of income is an important determinant of tax potential and that the large subsistence portions of the agricultural sectors in Central America preclude effective income taxation''\footnote{
	\citet[]{Mares2015} study how income taxation in Europe is associated to between-elites conflicts, particularly between the landed elite and the industrial elite. However, state-capacities are tangentially studied. \citet{SanchezdelaSierra2014} studies the relationship between taxation and state formation in Eastern Congo.}. We elaborate this insight by tracing down the \emph{political origins} of income taxation. As we explain in this paper, economic equality paired with political inequality introduced endogenous incentives to build both \emph{state} and \emph{democratic} institutions. Intra-elite inequality and regime type have been studied before (see for example \citet[Ch. 9]{Acemoglu:1996rm} and  \citet[]{Ansell:2014ty}). Our findings are consistent with \citet[p. 9]{Rueschemeyer:1992}, in that democratic ``[c]onsolidation of state power was an essential prerequisite for democratization''. One of our main contributions is the role of inter-elite inequality and political/institutional development. \citet[]{Garfias2015} finds in M\'exico the exact opposite: \emph{unequal} relative distribution of political and economical power causes state formation. The proposed mechanism is that ruling elites, taking advantage of their transitory strengthened  position, expropriate weaker elites and send bureaucrats to control local weakened bosses (his proxy for state capacities). We find that political monopolies were broken when the excluded industrial sector gained economic leverage that allowed them to bargain better political and economical conditions.
...
The system had to incorporate a proportional mechanism to allow agricultural incumbents to capture increasing industrial growth. Particularly, it had to be able to closely monitor industrial magnates and their personal incomes. In other words, an \emph{income tax} had to be implemented\footnote{
	...
	}.The long-term benefits of having a secured large tax source for the future offset the short-term costs of enjoying revenue extracted through small taxation doses. In other words, agricultural incumbents are better off having a rather small tax revenue secured for the future than having a relatively larger sum of money today, but exhausting and having nothing  in the future. In fact, it was in the agricultural incumbents' interest (the ``stationary bandit'') to protect and encourage industrial growth as that would translate into higher revenues for the treasury. As other have explained before, by imposing an income tax system, the treasury appoints itself as the investor's partner who will always share in the investor's gains and losses\footnote{\citet[p. 389]{Domar1944}.}.

% Concrete Examples
\autoref{fig:incometax} shows different sector sizes. Contrary to \citet[p. 241]{Bulmer-Thomas2003}, we do \emph{not} find that ``[e]verywhere [...]  industrial growth exceeded agricultural growth''. Chile had a very contested political economy: both sectors had approximately the same size. In fact, the industrial sector not only caught up agricultural output but also surpassed it around 1930, which is around the time when income taxation was imposed. The total opposite happened in Nicaragua. This country never had a strong industrial sector. Agricultural elites never felt challenged, and consequently income tax was introduced very late, around the 1980s. More qualitative evidence will be provided in the \hyperref[unpacking]{historical} section.

% consequences of income taxation: INSTITUTIONAL INVESTMENTS
The public economics literature focuses mostly on revenues. However, the politics of taxation is an equally important matter\footnote{\citet[]{Focanti:2015rt}.}. We claim that the new income tax was not important because of the extra revenue income taxation brought the treasury but because of the introduction of endogenous state institutions. Higher levels of inter-elite equality -i.e., higher levels of inter-elite contestation- led to the imposition of income taxation. This endogenous disturbance triggered a series of institutional investments. First, the political monopoly was broken. As simply promising keeping income tax rates constant was not credible, industrialists agreed to be taxed on their increasing incomes in exchange for political institutions that allowed them to participate in politics. A new competitive oligarchy was born. For example, political economists find that in less developed countries, higher tax collection levels are associated to strong political party systems\footnote{\citet[p. 8]{DiJohn2006}.}. Second, institutions of property right protection were needed\footnote{For example, \citet[p. 531]{Timmons2005} finds that ``[t]he more money a state raises from progressive taxes as a percentage of GDP [...] the better it protects property rights''. See also \citet[p. 6]{Roclrik2000} for a general overview.}. Now that both sectors had access to political resources, the two elites were interested in protecting each other's property from mutual expropriation. Alternative models developed to understand the European case suggest that the bourgeoisie seeks protection against the expropriative policies of the king. However, we claim that in Latin America, \emph{institutions protected the elite from themselves}. Given that open political systems are the most effective ones for processing and aggregating diverse interests\footnote{\citet[p. 3]{Roclrik2000}.}, both sectors could introduce institutions for macroeconomic stabilization and other regulatory institutions. Third, by encouraging optimal taxation rates, strong states were able to produce higher levels of economic growth\footnote{
...
}. Fourth, higher levels of economic growth and accumulation of human capital\footnote{
...
}, produced a larger middle class, composed by ``urban professionals, state employees in the private sector, artisans and craftsmen''\footnote{\citet[p. 185]{Rueschemeyer:1992}.}. As \citet[p. 394]{Collier:2002db} suggest, ``the middle classes did well under these [competitive oligarchies]. The size of the middle class expanded significantly not only as a result of economic growth in general,  but also as a result of growing public employment as the state expanded''\footnote{\citet[p. 12]{Geddes:1996fr} explains that government officials are self-interested individuals, and hence ``their responses differ''. However, we assume that the political interests of bureaucrats, presidents and congresses, are in line with their respective sectoral interests. Thus, we consider that ``the state''is itself an actor.}.

% consequences of income taxation: tariffs
Besides institutional investments, there were also economic compromises. The most important one was the introduction of higher/newer tariffs designed to protect the industrial sector. A common misconception is that industrial protectionism started with the ISI. ``The fact that manufacturing was alive and thriving in Latin America before the 1929 crash is now beyond question''\footnote{\citet[p. 129]{Bertola2012}.}. \citet[p. 3-4]{Haber2005} explains that ``governments followed policies designed to subsidize and protect industry in the decades after 1950 precisely because industrialists and industrial workers had been protected since the 1890s''. Early industrialists were able to bargain tariffs in exchange for income taxation. \citet[p. 53]{Lederman2005} shows how a protectionist cycle matches with the period for when income taxation was imposed\footnote{
...
% Weak States: A story of uncontested economic elites and political monopoly
\paragraph{Weak States: A story of uncontested economy and political monopoly} Strong-state cases are product of higher levels of inter-elite equality  which in turn lead to domestic political and economic structural transformations. Weak-state cases are product of unequal distribution of wealth within the elites. \citet[76]{Ansell:2014ty} argue that when inter-sectoral inequality is high, the landed elite expropriates indirectly through ``market-distorting policies'', harming rising elites such as the industrial elites. Similarly, we argue that when industrial output is not large-enough to compensate for long-term losses associated to future taxation of little revenues, incumbents engaged in predatory strategies. In other words, when discount factors exceeded the benefits associated to taxed industrial output in the long-run, ruling elites rather engaged in expropriation. For example, \citet[p. 255, 342-343]{Bulmer-Thomas2003} explain that was very common to nationalize non-agricultural assets such as transport companies, financial institutions, and mining industries, specially oil\footnote{They explain that ``the opposition of traditional agroexporters to Peronism in Argentina was consistent with state support for private investment in manufacturing'' (\citet[p. 339]{Bulmer-Thomas2003}).}. As \citet[p. 131]{Bertola2012} confirm it, most Latin American countries did not experience a proper industrialization process, and hence it is inaccurate to say that the industrial sector ``had become a strong engine of economic growth''.  


% Barriers to technology adoption: Link with other literature
Contrary to \citet[p. 127]{Acemoglu2000a}, industrial development is not blocked by agricultural elites ``because there is no credible commitment to compensate them once economic changes have been implemented''. However, expropriation acts as a way for rulers to provide instantaneous liquidity. One could argue the reverse. Given that economic changes alter the distribution of political power, when the industrial sector increases, so do the incentives for agricultural incumbents to expropriate them (rather than tax them, as we argue). For example \citet[p. 28]{Robinson1999} argues that ``[i]f development changes the political equilibrium, then this may deter elites from creating institutions and adopting policies which stimulate development'', engaging in predatory policies. However, why not profit from the other's growth? If the future is bright (based on fast industrial growth rates), incumbent elites should rather impose a tax, as \citet[]{Olson:2000aa}'s ``stationary bandits'' do. We claim that when  industrial growth is insignificant, the \emph{political} threat of being displaced by a weak economic sector is too small. Under these conditions, political concessions are not required and institutional investments are less likely. As \citet[p. 73]{Boix:2015aa} clarifies, ``states only exist to counteract a potential situation of conflict between agents with different economic interests and military capacities''. If there is not a counteracting party, institutions helped to  perpetuate the old agricultural order. Ultimately, barriers to technology adoption and industrial development were not implemented because of the fear of being \emph{politically} and/or \emph{economically} displaced, but because there was not added value for ruling elites letting industry grow.


% Bajada 
Agricultural rulers were not challenged and there were not incentives to invest in institutions. Institutions of property right protection were weak and were designed to enhance the monopolistic rule of agricultural incumbents. \citet{Ansell:2014ty} argue that in non-democratic regimes, the landed elite imposes predatory tax rates, keeping them for themselves entirely. These cases lack ``\emph{quasi-voluntary compliance}''\footnote{\citet{Levi:1989lq}.}. Hence, both the weak industrial elite and the masses evades those taxes (\citet{Boix2003}). Hostile fiscal policies did not generate incentives to grow an industrial sector. It was not necessary either to inject human capital into early bureaucracies. Taxing technologies then lacked the know-how and were not able to penetrate and efficiently monitor personal incomes. 
...
Industrial development is also a function of the incentives agricultural elites as political rulers had to block (or not) new technologies. However, this is not a story of \emph{economic losers}, in which (usually) monopolies block substitute technologies by increasing barriers to technology adoption\footnote{See \citet{Parente1994a}.}. Rather, the argument presented here is about elites afraid of being \emph{political losers}. In line with \citet{Acemoglu2000a}, political monopolists could not afford to endanger their relative stronger political position by being displaced economically. These structural transformations are deeply linked to democratic development. As \citet[p. 7]{Rueschemeyer:1992} argue, ``capitalist development is associated with democracy because it transforms the class structure''. We focused in one of these class transformations, particularly within the elite, namely, the emergence (or not) of an industrial class and the decline (or not) of the agricultural/traditional sector. 
