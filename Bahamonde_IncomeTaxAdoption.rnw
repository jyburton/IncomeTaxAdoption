...
% HERE: continue editing and proof reading the paper.
...
% Overview
Our argument comes in four parts for both the ``weak'' and ``strong'' state cases. We first layout our theory in abstract. Then we develop each part of the argument in greater detail. Next \hyperref[unpacking]{section} illustrate the causal mechanisms at work.
...
By definition, political monopolies also limit entrance of alternative parties/groups into the political system. All monopolies generate waste and negative externalities. In this case, and as the \hyperref[unpacking]{historical} section illustrates, we argue that \emph{political} monopolies, that is, a situation where political competition is artificially limited, generate  political and economic distortions. In this case, the agricultural sector would artificially impose policies convenient for their own sector, at the expenses of the non-represented segments of the society. 
...
Higher levels of inter-elite equality, propitiated by healthy industrial outputs, were able to break initial monopolistic conditions of the traditional sector. Building on the idea of the ``stationary bandit''\footnote{\citet[]{Olson:2000aa}.}, this paper develops two possible strategies for agricultural political incumbents. Each one is best response depending on the rate of industrial growth. The first strategy is to engage in \emph{predatory practices}, expropriating industrial output and enjoying short-term benefits associated to immediate liquidity. Given that human capital and investments are non-transferable between the two sectors\footnote{For example, machines used to make glass can't be used to grow potatoes.}, for the next term, industrial output is exhausted and its output gets closer to zero. That is, when agricultural elites expropriate industries, since they don't know how to manage them, they end up bankrupting them. This strategy is best response when the rate of industrial growth is slow. Here, the benefits associated to expropriate industrial output ``today'' offset the benefits of rather encouraging industrial production and tax it ``tomorrow''. In simply words, the long-term benefits of having a secured, \emph{but excessively small} source of tax revenue \emph{do not} offset the benefits associated to have immediate resources. The second strategy consists of \emph{institutional investments} that allowed agricultural incumbents to ``rob'' industrial output in small doses at a time through a direct taxation system. This idea is consistent with \citet[p. 126]{Acemoglu2000a} too, in that potentially political losers instead of blocking innovation\footnote{It is important to stress that we do \emph{not} refer to domestic technological innovation. Rather, technological innovation should be assumed to be exogenous. As \citet[p. 135]{Bertola2012} explain, ``[t]he main two vehicles for international technology transfer [...] were foreign investment and immigration [...] [m]any immigrants already had the experience of living in an industrial civilization; they brought with them knowledge, practical experience, an entrepreneurial and technical culture, a work ethic, knowledge of new forms of commercial organization''.}, impose a tax. 
...
In cases where industrial growth kept growing at faster rates, agricultural political incumbents incorporated a proportional fiscal mechanism to capture increasing tax rates. Particularly, it had to be able to monitor closely industrial magnates and their personal incomes. In other words, an \emph{income tax} had to be implemented\footnote{We build on the idea that political elites generally are better able to impose/raise taxes during economic booms. For example, \citet[p. 647]{Campbell1994} argue that ``economic development should be directly related to individual and corporate income tax rates''. Also, \citet[p. 59]{Besley:2011aa} argue that ``investing in fiscal capacity becomes more attractive [...] when wages or incomes [...] are higher''.}. The long-term benefits of having a secured large tax source for the future offset the short-term costs of enjoying revenue extracted through small taxation doses. In other words, agricultural incumbents were better off having a rather small tax revenue secured for the future than having a relatively larger sum of money ``today'', than exhausting it and having nothing ``in the future''. In fact, it was in the agricultural incumbents' interest to protect and encourage industrial growth as that would translate into higher revenues for the treasury. As other have explained before, by imposing an income tax system, the treasury appoints itself as the investor's partner who will always share in the investor's gains and losses\footnote{\citet[p. 389]{Domar1944}.}.
