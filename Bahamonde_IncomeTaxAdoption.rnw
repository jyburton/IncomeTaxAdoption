...
Finally, it is important to say that our theoretical model does not require European-like degrees of industrialization. As \citet[131]{Bertola2012} confirm it, most Latin American countries did \emph{not} experience a proper industrialization \emph{process}, and hence it is inaccurate to say that the industrial sector ``had become a strong engine of economic growth''. However, even when Latin America did not experience an industrial \emph{revolution}, the modern sector did experience clusters of development\footnote{See \autoref{fig:incometax}.}. 
...
There are many factors that explain the industrial development in LA. Among them, tariffs oriented to protect the \emph{agricultural} market \emph{unintentionally} helped protecting the industrial sector. Since the first industries processed raw agricultural materials, better conditions for the land helped industrialists make their way into the economy. Favorable international markets also boosted the demand for rudimentary processed raw products. \autoref{fig:incometax} shows output differentials (in logarithmic scales) since 1900 to 2010, for a sample of Latin American countries\footnote{We use the \emph{Montevideo-Oxford Latin American Economic History Data Base}  (\href{http://moxlad-staging.herokuapp.com/home/en?}{MOxLAD}), specifically the \emph{agriculture value-added} and \emph{manufacturing value-added} variables. The former measures ``the output of the sector net of intermediate inputs and includes the cultivation of crops, livestock production, hunting, forestry and fishing''. The later  ``[r]eports the output of the sector net of intermediate inputs''. Both of them are expressed in local currency at 1970 constant prices. Finally, ``the depreciation of reproducible assets or depletion/degradation of natural resources were not deducted''. Details about this dataset are presented in the data \hyperref[data]{section}. The plot also shows a vertical line which indicates when the income tax law was passed (author's data based on several reports and official information). We elaborate on the income tax law in the next \hyperref[tax:expr:ind]{section}.}. Contrary to \citet[241]{Bulmer-Thomas2003}, we do \emph{not} find that ``[e]verywhere [...]  industrial growth exceeded agricultural growth''.

<<incometax, echo = FALSE, fig.pos='h', warning = FALSE, message = F, fig.cap='Industrial and Agricultural Outputs, and Political Contestation', fig.align='center', fig.width=13, fig.height=12,dpi=300,cache = FALSE>>=

@

% first type of conflict is inter-elite economic and political competition
Sectoral competition is one of our main building blocks, and this paper measures it with output differentials (\autoref{fig:incometax}). The first type of conflict is inter-elite political and economic competition. The literature is consistent in agreeing that higher levels of both lead to ``better'' outcomes. For example, \citet[481]{Kurtz2009} argues that where ``no faction can easily become permanently dominant'', state capacities should be stronger. Similarly, \citet{Geddes1991} argues that competition between two rival parties of about the same size create the incentives to invest in political institutions. \citet[40]{Cardenas2010} in his formal and empirical models also finds that ``concentration of political and economic power reduces the incentives to invest in state capacity''\footnote{However, he models inequality between \emph{elites} and \emph{citizens}. We expand on this idea by modeling the period \emph{before} full democratization existed and also by modeling inter-elite conflicts.}. Though the nature of this conflict is both political and military, its root is economic (sectoral outputs). Better economic conditions can relatively easily be translated into better military capacities, which makes it easier for the advantaged elite to impose their political agenda in a monopolistic way (\citet{Boix:2015aa}). Contested economies led to contested political systems via inter-elite bargains, and to the development of earlier fiscal capacities. Moreover, sectoral output differentials reflect structural economic dynamics between the two sectors that make them compete for limited supply of labor\footnote{As \citet[p. 318]{Matsuyama1992} puts it, ``the manufacturing sector has to compete with the agriculture sector for labor. Low productivity in agriculture implies the abundant supply of ``cheap labor'' which the manufacturing can rely on''. See also \citet[160]{Gollin2002}.} making the competition of the two elites more evident. In fact, in order for the modern sector to develop, the traditional sector has to decay\footnote{\citet[621-622]{Matsuyama1991} argues that the process of ``[i]ndustrialization [consists of] a shift of resources from agriculture to manufacturing''.}. For example, \citet[642-643]{Matsuyama1991} explains that ``a takeoff is possible in an economy with less productive agriculture, while an economy with productive agriculture will be trapped into the state of preindustrialization''\footnote{\citet[293]{Skott1998} points out that ``an increase in the growth rate of agricultural productivity may reduce the rate of growth of real income under free trade''}. As we will see in our \hyperref[unpacking]{case study} section, this is true for Chile. However, it also applies to other Latin American economies too. For example, \citet[p. 8]{Bash1986} explains that ``Colombia's two traditional political parties crystallized in the 1840's and reflected in many respects the dual nature of the Colombian economy''.
...
The second type of conflict is a reflection of the first one, and it relates to the sectoral origins of income taxation. As development economists argue, there is an intrinsic sectoral conflict between the two sectors regarding generation of income and its potential taxation (\citet[55]{Best1976}). Similarly, \citet[]{Mares2015} study how income taxation in Europe is associated to between-elites conflicts, particularly between the landed elite and the industrial elite. Taxation and state formation has been studied in Africa too. For example, \citet{SanchezdelaSierra2014} studies the relationship between taxation and state formation in Eastern Congo. 

% what happens when the industrial sector grows slowly.
\emph{Economic equality paired with political inequality introduced endogenous incentives to build both state and democratic institutions}. However, when there exists inter-elite economic \emph{inequality}, that is, when the traditional sector is the only strong sector, contestation by the industrialist is not credible. In these circumstances, the initial conditions of political inequality are not broken and the political system tends to over represent the interests of one sector, the agricultural elite. For example, Nicaragua was formed in a non-democratic context, just like any other country in our panel. However, unlike the other nations, the industrial sector did not grow fast enough to challenge the traditional sector (\autoref{fig:incometax}), leaving the political system unaltered until the 1980s (see \autoref{fig:democracy:plot}). The lack of inter-elite contestation led this country to develop a very late fiscal system (\autoref{fig:incometax}). An opposite example is Ecuador, which passed the income tax just before the 1950s, which is just where it had its first ``democratic'' experience. 
...
% PUT THIS PARAGRAPH SOMEWHERE WITHIN THIS SECTION
%Intra-elite (in)equality and regime type
The unstable relationship between intra-elite political (in)equality, economic equality and regime type is another important building block. There have been important recent contributions lately (see for example \citet[Ch. 9]{Acemoglu:1996rm} and  \citet[]{Ansell:2014ty}). Building on this literature, we specifically introduce the state-building question. Our argument is related to \citet[9]{Rueschemeyer:1992}, in that ``[c]onsolidation of state power was an essential prerequisite for democratization''. However, we relax the causal direction of this mechanism by proposing an endogenous process. Specifically, we argue that inter-elite political inequality paired with inter-elite economic equality was the unstable equilibrium that gave way to the domestic inter-elite bargaining processes that lead several structural transformations, both political and economic. 
...
When it comes to taxation, the public economics literature focuses mostly on tax revenues. However, the \emph{politics} of taxation is an equally important matter\footnote{\citet[]{Focanti2013}.}. We claim that the new income tax was not important because of the extra revenue income taxation brought the treasury but because of the introduction of endogenous state institutions. Higher levels of inter-elite equality -i.e., higher levels of inter-elite contestation- led to the imposition of income taxation. This endogenous disturbance triggered a series of institutional investments. Most notably, the introduction of political representation for the industrial elites and industrial tariffs. \autoref{fig:democracy:plot} shows the regime type for each country\footnote{From \citet[]{Boix2012}.}. We claim that the introductions of the income tax\footnote{The vertical line in \autoref{fig:incometax}.} and the first democratic waves are part of the same process, namely, a process of inter-elite dispute (expressed in sectoral output differentials). Critically, both outcomes (oligarchic democracies and fiscal capacities) are not a function of what modernization theorists argue about\footnote{\citet[31]{Lipset:1981uq} for example argues that democracy is ``related to the state of the economy. The more well-to-do a nation, the greater the chances it will sustain democracy''.}. As we explain in \autoref{methods}, economic well-being indicators do not predict fiscal capacities nor oligarchic democracy. The way in which industrialization is associated to state-building is not channeled through ``well-being'' but trough inter-elite contestation.

 
% CONTINUE FIXING HERE


It is important to stress that this is a situation of ``\emph{quasi-voluntary compliance}''\footnote{\citet{Levi:1989lq}.}. Even when the industrial sector in strong-state cases continue having increasing outputs (and hence, higher taxes to pay), they are still better off paying income taxes to continue receiving economic protection (tariffs) as we explain below.

%%% PUT SURVIVAL GRAPH HERE
...
<<coxassump, echo = FALSE, fig.pos='H', warning = FALSE, message = F, fig.cap='Graphical Plots of the Estimates against Time', fig.align='center', fig.width=5, fig.height=6,dpi=300,cache = FALSE>>=
