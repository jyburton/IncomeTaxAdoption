...
\paragraph{Weak States: A story of uncontested economic elites and political monopoly} When industrial output was not large-enough to compensate for long-term losses associated to future taxation of little revenues, incumbents engaged in predatory strategies. Contrary to \citet[p. 127]{Acemoglu2000a}, industrial development is not blocked by agricultural elites ``because there is no credible commitment to compensate them once economic changes have been implemented''. However, in this case blocking/expropriation acts as a way to provide to the rulers instantaneous liquidity in the short-term. One could argue another causal chain. Economic changes alter the distribution of political power. When the industrial sector increases, so do the incentives for incumbents to expropriate them. For example, \citet[p. 28]{Robinson1999} argues that ``[i]f development changes the political equilibrium, then this may deter elites from creating institutions and adopting policies which stimulate development''. However, 




Yet, the traditional sector is at the same time the political monopolist, the \emph{political} threat of being displaced by a weak economic sector is too small. 
